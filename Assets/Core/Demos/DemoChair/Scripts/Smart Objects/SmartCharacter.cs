...
public class SmartCharacter : SmartObject
{
    ...
    [Affordance]
    protected Node TakeKeysFromBehind(SmartCharacter user)
    {
        return new Sequence(
    ...
    [Affordance]
    protected Node TakeWallet(SmartObject user)
    {
        SmartCharacter character = (SmartCharacter)user;
    ...
    public Node Steal(SmartObject user)
    {
        ...
        return new Sequence(
            ...
            new SelectorParallel(
                character.Node_GoToUpToRadius(Val.V(() => this.transform.position), 0.7f),
                new LeafWait(1500)), // Timeout
            character.Node_OrientTowards(Val.V(() => this.transform.position)),
    ...
    protected Node ST_TalkHappily(SmartCharacter user)
	{
        return ST_Converse(
            user,
            happyConversation.Item1,
            happyConversation.Item2);
	}
