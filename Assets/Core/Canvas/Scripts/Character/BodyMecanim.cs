    ...
    public void HandAnimation(string gestureName, bool isActive)
    {
        ...
        switch (gestureName.ToUpper())
        {
            ...
            case "WRITING":
                ...
                break;
			case "DISMISS":
				this.animator.SetBool("H_Dismiss", isActive);
				break;
			case "SHORTCLAP":
				this.animator.SetBool("H_ShortClap", isActive);
				break;
			case "ROAR":
				this.animator.SetBool("H_BattleRoar", isActive);
				break;
            case "LOSER":
                this.animator.SetBool("H_Loser", isActive);
                break;
        }
    }
