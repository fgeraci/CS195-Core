...
public class StatusIcon2 : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        if (StatusIcon2.manager == null)
            StatusIcon2.manager = new IconResourceManager(ICON_PATH);
        this.text = this.gameObject.GetComponentInChildren<TextMesh>();
    }
    ...
    public void SetIcon(string iconName)
    {
        ...
        this.GetComponent<Renderer>().material.mainTexture =
            StatusIcon2.manager.GetIcon("blank");
        
        this.text.text = SplitText(iconName, 22);
    ...
    string SplitText(string input, int lineLength)
    {
        string result = "";
