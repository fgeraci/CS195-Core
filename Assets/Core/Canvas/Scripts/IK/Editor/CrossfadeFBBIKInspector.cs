...
/*
    * Custom inspector for CrossfadeFullBodyBipedIK.
    * */
[CustomEditor(typeof(CrossfadeFBBIK))]
public class CrossfadeFBBIKInspector : IKInspector
{

    private CrossfadeFBBIK script { get { return target as CrossfadeFBBIK; } }
